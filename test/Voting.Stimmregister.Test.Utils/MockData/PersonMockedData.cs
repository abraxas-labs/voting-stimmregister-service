...
public static class PersonMockedData
{
    ...
    public const long Ahvn13ForMultiValueFilterTest = 756_1234_5678_73;
    ...
    public static PersonEntity Person_3203_StGallen_2
        => new()
        {
            ...
            CreatedDate = MockedClock.GetDate(),
            Vn = Ahvn13ForMultiValueFilterTest,
            MunicipalityId = MunicipalityIdStGallen,
            MunicipalityName = MunicipalityNameStGallen,
            ...
            ResidenceCantonAbbreviation = "SG",
            ResidenceCountry = "CH",
            ResidenceAddressExtensionLine1 = "Miss",
            ResidenceAddressExtensionLine2 = "Bal",
            ResidenceAddressPostOfficeBoxText = "Postf.",
            Country = "CH",
            CountryNameShort = "Schweiz",
            RestrictedVotingAndElectionRightFederation = false,
            IsValid = true,
            ...
            ContactAddressLine2 = "Meg Bal",
            ContactAddressLine3 = "Sturzeneggstr.",
            ContactAddressLine4 = "Postf. 1",
            ContactAddressLine5 = "9016 St. Gallen",
            ContactAddressLine6 = "CH",
            ContactAddressLine7 = "Schweiz",
            ContactAddressLocality = "Haggen",
            ContactAddressStreet = "Nebenstrasse",
            ContactAddressHouseNumber = "20",
            ContactAddressTown = "Haggen",
            ContactAddressDwellingNumber = "20",
            ContactAddressExtensionLine1 = "Miss",
            ContactAddressExtensionLine2 = "Bal",
            ContactAddressZipCode = "9030",
            ContactAddressPostOfficeBoxText = "Postf.",
            ContactAddressCountryIdIso2 = "CH",
            SendVotingCardsToDomainOfInfluenceReturnAddress = true,
            MoveInMunicipalityName = "Vaduz",
            MoveInComesFrom = "Vaduz",
            MoveInCantonAbbreviation = "LI",
            MoveInCountryNameShort = "Liechtenstein",
            SourceSystemName = ImportSourceSystem.Loganto,
            CantonBfs = CantonBfsStGallen,
        };
    ...
    public static PersonEntity Person_3213_Goldach_1
        => new()
        {
            ...
            ResidenceAddressHouseNumber = "60",
            ResidenceAddressZipCode = "9016",
            ResidenceAddressTown = "Goldach",
            ResidenceCantonAbbreviation = string.Empty,
            ResidenceCountry = "CH",
            ResidenceAddressExtensionLine1 = "Mister",
            ResidenceAddressExtensionLine2 = "Ross",
            ResidenceAddressPostOfficeBoxText = "Postfach123",
            Country = "CH",
            CountryNameShort = "Schweiz",
            RestrictedVotingAndElectionRightFederation = false,
            IsValid = true,
            IsLatest = true,
            DeletedDate = null,
            ContactAddressLine1 = "Herr",
            ContactAddressLine2 = "Mike Ross",
            ContactAddressLine3 = "Libellenstr.",
            ContactAddressLine4 = "Postfach 123",
            ContactAddressLine5 = "9099 Vaduz",
            ContactAddressLine6 = "LI",
            ContactAddressLine7 = "Liechtenstein",
            ContactAddressLocality = "Wittenbach",
            ContactAddressStreet = "Hauptstrasse",
            ContactAddressHouseNumber = "21",
            ContactAddressTown = "Wittenbach",
            ContactAddressDwellingNumber = "21",
            ContactAddressExtensionLine1 = "Mister",
            ContactAddressExtensionLine2 = "Ross",
            ContactAddressZipCode = "9300",
            ContactAddressPostOfficeBoxText = "Postfach123",
            ContactCantonAbbreviation = "ZH",
            ContactAddressCountryIdIso2 = "CH",
            MoveInMunicipalityName = "Bern",
            MoveInComesFrom = "Bern",
            MoveInCantonAbbreviation = "BE",
            MoveInCountryNameShort = "Schweiz",
            SourceSystemName = ImportSourceSystem.Loganto,
            CantonBfs = CantonBfsStGallen,
        };
