...
public class LogantoPersonImportRestTest : BaseImportRestTest
{
    private readonly IImportStatisticRepository _importStatisticRepository;

    public LogantoPersonImportRestTest(TestApplicationFactory factory)
        : base(factory)
    {
        _importStatisticRepository = GetService<IImportStatisticRepository>();
    }

    protected override string ImportEndpointUrl => "v1/import/loganto/persons";

    protected override string ValidFileName => "Loganto_Person_valid.csv";
