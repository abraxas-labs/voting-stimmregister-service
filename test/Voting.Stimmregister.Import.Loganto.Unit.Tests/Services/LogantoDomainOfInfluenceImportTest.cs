...
public class LogantoDomainOfInfluenceImportTest : BaseWriteableDbTest
{
    ...
    private static readonly string _testFilesPath = Path.Combine("Services", "_files", "Loganto", "DomainOfInfluence");
    ...
    public async Task ShouldCreateDomainOfInfluencesWhenFileValid()
    {
        ...
        domainOfInfluenceEntities.ForEach(p => p.Signature = Array.Empty<byte>());
