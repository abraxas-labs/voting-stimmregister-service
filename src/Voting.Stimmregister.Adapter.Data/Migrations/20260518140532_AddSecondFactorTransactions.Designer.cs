...
namespace Voting.Stimmregister.Adapter.Data.Migrations
{
    ...
    [Migration("20260518140532_AddSecondFactorTransactions")]
    partial class AddSecondFactorTransactions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.FilterCriteriaEntity", b =>
                {
                    ...
                    b.Property<Guid?>("LastSearchParameterId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LastSearchParameterId");

                    b.HasIndex("FilterId", "ReferenceId")
                        .IsUnique();

                    b.HasIndex("FilterVersionId", "ReferenceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.FilterVersionEntity", b =>
                {
                    ...
                    b.Property<int>("CountOfInvalidPersons")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.ImportStatisticEntity", b =>
                {
                    ...
                    b.Property<byte[]>("AcmAesIv")
                        .IsRequired()
                        .HasColumnType("bytea");

                    b.Property<byte[]>("AcmEncryptedAesKey")
                        .IsRequired()
                        .HasColumnType("bytea");

                    b.Property<byte[]>("AcmEncryptedMacKey")
                        .IsRequired()
                        .HasColumnType("bytea");

                    b.Property<byte[]>("AcmHmac")
                        .IsRequired()
                        .HasColumnType("bytea");
                    ...
                    b.HasIndex("IsLatest", "MunicipalityId", "SourceSystem", "ImportType")
                        .IsUnique()
                        .HasFilter("\"IsLatest\"");
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.LastSearchParameterEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "UserId", "SearchType")
                        .IsUnique();

                    b.ToTable("LastSearchParameters");
                });
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.PersonEntity", b =>
                {
                    ...
                    b.Property<int?>("ContactAddressPostOfficeBoxNumber")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.SecondFactorTransactionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<List<string>>("NevisExternalTokenJwtIds")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.BfsIntegrityEntity", b =>
                {
                    b.OwnsOne("Voting.Stimmregister.Domain.Models.AuditInfo", "AuditInfo", b1 =>
                        {
                            b1.Property<Guid>("BfsIntegrityEntityId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("BfsIntegrityEntityId");

                            b1.ToTable("BfsIntegrities");
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.FilterCriteriaEntity", b =>
                {
                    ...
                    b.HasOne("Voting.Stimmregister.Domain.Models.LastSearchParameterEntity", "LastSearchParameter")
                        .WithMany("FilterCriteria")
                        .HasForeignKey("LastSearchParameterId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("LastSearchParameter");
                });
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.LastSearchParameterEntity", b =>
                {
                    b.OwnsOne("Voting.Lib.Database.Models.Pageable", "PageInfo", b1 =>
                        {
                            b1.Property<Guid>("LastSearchParameterEntityId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("LastSearchParameterEntityId");

                            b1.ToTable("LastSearchParameters");

                            b1.WithOwner()
                                .HasForeignKey("LastSearchParameterEntityId");
                        });
