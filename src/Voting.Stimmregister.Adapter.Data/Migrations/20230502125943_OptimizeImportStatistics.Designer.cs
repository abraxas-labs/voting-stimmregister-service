...
namespace Voting.Stimmregister.Adapter.Data.Migrations
{
    ...
    [Migration("20230502125943_OptimizeImportStatistics")]
    partial class OptimizeImportStatistics
    {
            ...
            modelBuilder.Entity("Voting.Stimmregister.Domain.Models.ImportStatisticEntity", b =>
                {
                    ...
                    b.HasIndex("IsLatest", "MunicipalityId")
                        .IsUnique();

                    b.HasIndex("SourceSystem", "ImportType", "Id");
