...
namespace Voting.Stimmregister.Core.Import.Innosolv.Mapping;
...
internal class InnosolvPersonMapper : BasePersonMapper<PersonInfoType>
{
    ...
    public InnosolvPersonMapper(IClock clock, ImportsConfig importConfig, ICountryHelperService countryHelperService)
        : base(clock, ImportSourceSystem.Innosolv, countryHelperService)
    {
        _importConfig = importConfig;
    }

    protected override void MapRecordToPersonEntity(PersonImportStateModel state, PersonInfoType record, PersonEntity entity)
    {
    ...
    private void MapDistrictsToDomainOfInfluences(PersonEntity entity, PersonInfoType record)
    {
        ...
        foreach (var district in record.District)
        {
            entity.PersonDois.Add(new PersonDoiEntity
            {
                ...
                {
                    "CH" => DomainOfInfluenceType.Ch, // Bund
                    "CT" => DomainOfInfluenceType.Ct, // Kanton
                    ...
                    "SC_PS" or "SCPS" => DomainOfInfluenceType.ScPs, // Primarschulgemeinde
                    "SC_OS" or "SCOS" => DomainOfInfluenceType.ScOs, // Oberstufenschulgemeinde
                    "KI_KA" or "KIKAT" => DomainOfInfluenceType.KiKat, // Katholische Kirchgemeinde
                    "KI_EV" or "KIEVA" => DomainOfInfluenceType.KiEva, // Evangelische Kirchgemeinde
                    ...
                    "ANWOK" => DomainOfInfluenceType.AnWok, // Wohnviertel
                    "ANVOK" => DomainOfInfluenceType.AnVok, // Volkskreis
                    _ => DomainOfInfluenceType.An, // Andere
                },
            });
        }
    }
    ...
    {
        var residenceAddress = record.HasMainResidence?.DwellingAddress.Address
        ...
        entity.ContactAddressExtensionLine1 = residenceAddress.AddressLine1;
        entity.ContactAddressExtensionLine2 = residenceAddress.AddressLine2;
        entity.ContactAddressStreet = residenceAddress.Street;
        entity.ContactAddressHouseNumber = residenceAddress.HouseNumber;
        entity.ContactAddressDwellingNumber = residenceAddress.DwellingNumber;
