...
public abstract class IncrementalPersonPayloadBuilderV1<T> : IDisposable, IIncrementalSignaturePayloadBuilder<T, PersonEntity>
{
    private readonly PersonSignaturePayloadBuilderV1 _personPayloadBuilder;
    private readonly SignaturePayloadBuilder _builder;
    private PersonEntity? _previousPerson;
    private bool _disposedValue;

    protected IncrementalPersonPayloadBuilderV1(
        string typeName,
