...
internal class IntegritySignaturePayloadBuilderV3 : IncrementalPersonPayloadBuilderV3<BfsIntegrityEntity>, IIntegritySignaturePayloadBuilder
{
    private readonly DomainOfInfluenceSignaturePayloadBuilderV1 _doiBuilder;
    private bool _disposedValue;

    public IntegritySignaturePayloadBuilderV3(
