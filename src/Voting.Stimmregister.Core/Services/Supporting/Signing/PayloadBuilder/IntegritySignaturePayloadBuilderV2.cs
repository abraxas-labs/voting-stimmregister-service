...
internal class IntegritySignaturePayloadBuilderV2 : IncrementalPersonPayloadBuilderV2<BfsIntegrityEntity>, IIntegritySignaturePayloadBuilder
{
    private readonly DomainOfInfluenceSignaturePayloadBuilderV1 _doiBuilder;
    private bool _disposedValue;

    public IntegritySignaturePayloadBuilderV2(
