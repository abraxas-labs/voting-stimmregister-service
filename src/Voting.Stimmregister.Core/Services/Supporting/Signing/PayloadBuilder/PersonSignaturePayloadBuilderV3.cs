...
public class PersonSignaturePayloadBuilderV3 : IDisposable, ISignaturePayloadBuilder<PersonEntity>
{
    private readonly SignaturePayloadBuilder _payloadBuilder;
    private bool _disposedValue;

    public PersonSignaturePayloadBuilderV3(
    ...
    public SignaturePayload Build(PersonEntity person)
    {
        _payloadBuilder.HashBuilder
            ...
            .AppendDelimited(person.EVotingEmail)
            ...
            .AppendDelimited(person.IsHouseholder)
            .AppendDelimited(person.ResidenceBuildingId)
            .AppendDelimited(person.ResidenceApartmentId);
