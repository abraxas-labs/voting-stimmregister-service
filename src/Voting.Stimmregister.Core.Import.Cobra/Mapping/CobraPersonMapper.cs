...
namespace Voting.Stimmregister.Core.Import.Cobra.Mapping;
...
public class CobraPersonMapper : BasePersonMapper<CobraPersonCsvRecord>
{
    ...
    public CobraPersonMapper(ICountryHelperService countryHelper, IClock clock)
        : base(clock, ImportSourceSystem.Cobra, countryHelper)
    {
        ...
        PersonEntity entity)
    {
        ...
        entity.MunicipalityName = state.MunicipalityName;
        ...
        entity.ContactAddressCountryIdIso2 = _countryHelper.GetCountryTwoLetterIsoCode(record.ResidenceCountry, record.BfsCountry);
        ...
        MapContactAddressLineExtensions(entity, record);
    ...
    /// <seealso cref="MapContactAddressLineExtensions"/>.
    /// </summary>
    ...
    private static void MapContactAddressLineExtensions(PersonEntity entity, CobraPersonCsvRecord record)
    {
